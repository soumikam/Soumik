...
const CONTENT = {
  ...
  cgi: [
    // Replace with your actual renders. Use placeholder text until you have media.
    {
      ...
      video: "", youtube: "1asE6F4TeGs", image: "",
    ...
    },
    {
      ...
      video: "", youtube: "86x7OcMiqm0", image: "",
    ...
    },
    {
      ...
      video: "", youtube: "PQAJ9PIeREk", image: "",
    ...
    {
      title: "Airship goes BRRR! — Render Challenge Breakdown",
      category: "Breakdown",
      tags: ["Blender", "After Effects", "Nuke", "Kitbash 3D", "Compositing"],
      video: "", youtube: "yJcxbBs8Bjw", image: "",
      desc: "Submission breakdown for the Endless Engines Render Challenge. 2 days to conceptualize and build 3D assets, 3 hours in post — color grading, fog compositing in Nuke and After Effects.",
      link: "https://www.youtube.com/watch?v=yJcxbBs8Bjw",
    },
    {
      title: "Assassin's Creed Tribute Montage",
      category: "Character",
      tags: ["Blender", "After Effects", "RedGiant", "Animation", "Cinematic", "4K"],
      video: "", youtube: "8APXc2SmFOg", image: "",
      desc: "A fan-made cinematic tribute to the Assassin's Creed universe — animated renditions of Ezio, Altair, and Bayek set against iconic historical backdrops. Crafted in Blender and After Effects using RedGiant Trapcode and Universe Suite.",
      link: "https://www.youtube.com/watch?v=8APXc2SmFOg",
    },
    {
      title: "X-GEN JETSKI — Product Reveal Cinematic",
      category: "FX",
      tags: ["Blender", "After Effects", "Nuke", "Substance 3D", "Cinematic", "4K"],
      video: "", youtube: "sBvW6zPru5E", image: "",
      desc: "Cinematic product reveal for the X-GEN JETSKI, made for X1 Racing. Modeled and rendered in Blender, textured in Substance 3D Painter, composited in After Effects and Nuke.",
      link: "https://www.youtube.com/watch?v=sBvW6zPru5E",
    },
    {
      title: "Apocalyptic Mutant Is Born — Render Challenge",
      category: "Character",
      tags: ["Blender", "Maya", "ZBrush", "Nuke", "Kitbash 3D", "Cinematic", "4K"],
      video: "", youtube: "LTZcqSeXsG4", image: "",
      desc: "Entry for the Infinite Journeys 3D Render Challenge — an apocalyptic sci-fi scene of a robot scientist incubating a mutant species aboard a ruined train. Modeled in Blender, ZBrush and Maya; composited in After Effects and Nuke.",
      link: "https://www.youtube.com/watch?v=LTZcqSeXsG4",
    },
    {
      title: "Quantum Rhythms — Cosmic Music Video",
      category: "FX",
      tags: ["Blender", "After Effects", "RedGiant", "Cinematic", "4K"],
      video: "", youtube: "e6DgLES_Rrk", image: "",
  ...
  experience: [
    {
      ...
      tags: ["Unity URP", "HLSL", "C#", "ShaderGraph", "Pipeline Optimization", "RenderDoc", "VFX"],
      nodes: ["URP Pipeline", "HLSL Shaders", "ShaderGUI", "Bink Video", "Piggy Bankin'", "Power of Pyramid"],
    },
    {
      role: "Motion Design & CG Artist",
      company: "EDIIIE",
      location: "Chandigarh, India",
      period: "Jul 2023 – Jan 2024",
      type: "professional",
      logo: "assets/img/logos/ediiie.svg",
      bullets: [
        "Produced 3D short films, cinematics, and game trailers for international clients",
        "Delivered product showcases with Blender/Maya renders composited in After Effects",
        "Built Unity VFX graph, particle systems, and sprite animations for client projects",
      ],
      tags: ["Blender", "Maya", "After Effects", "Unity", "CGI"],
      nodes: ["Game Trailers", "Cinematics", "VFX Graph", "After Effects", "3D Short Films"],
    },
    {
      ...
      type: "professional",
      logo: "assets/img/logos/cognizant.svg",
      bullets: [
        "Developed backend APIs using Java, Spring Boot, and Eclipse IDE",
      ],
      tags: ["Java", "Spring Boot", "Backend"],
      nodes: ["Java", "Spring Boot", "Eclipse IDE"],
    },
    {
      ...
      type: "education",
      logo: "assets/img/logos/kgec.svg",
      bullets: [
        "CGPA: 9.04 / 10",
    ...
    {
      role: "Higher Secondary (ISC 2018, ICSE 2016)",
      company: "S.E.RLY. Mixed Higher Secondary School",
      location: "Kharagpur, India",
      period: "2005 – 2018",
      type: "education",
      logo: "assets/img/logos/SERLY-Mixed.svg",
      bullets: [
        "Higher Secondary (Class XII): 93%",
        "Secondary Examination (Class X): 94%",
      ],
      tags: ["ISC", "ICSE"],
    },
